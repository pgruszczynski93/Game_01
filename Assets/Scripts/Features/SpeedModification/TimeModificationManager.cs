...
namespace PG.Game.Features.SpeedModification {
    public class TimeModificationManager : BonusDrivenBehaviour {
        ...
        protected override void ManageEnabledBonus() {
            ...
            if (PlayerBonusesManager.IsBonusActive(BonusType.EnergyBoost))
                return;
        ...
        protected override void SubscribeEvents() {
            ...
            GameplayEvents.OnSpeedModificationRequested += HandleOnSpeedModificationRequested;
        ...
        void SetEnergyBoostMultiplierEndVal() {
            float toModifier = PlayerBonusesManager.IsBonusActive(BonusType.TimeModSlowAll)
